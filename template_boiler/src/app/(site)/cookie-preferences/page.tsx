      ...
      <div className="page-header-section">
        <div className="page-width">
          <div className="page-header-content">
            ...
            <p className="page-subtitle">Manage your cookie and tracking preferences</p>
        ...
        <div className="page-width">
          <div className="policy-content">
            ...
            <section>
              ...
              <div className="cookie-category">
                <h3>⚙️ Functional Cookies (Optional)</h3>
            ...
            <section className="cookie-actions">
              <h2>Update Your Preferences</h2>
              <p>You can change your cookie preferences at any time:</p>
              
              <div className="action-buttons">
                <button className="btn-primary">Accept All Cookies</button>
                <button className="btn-secondary">Accept Essential Only</button>
                <button className="btn-outline">Customize Settings</button>
              </div>
              
              <p className="preference-note">Your preferences will be saved and applied immediately.</p>
            </section>
